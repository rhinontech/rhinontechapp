...
export function LeadsPage() {
  ...
  return (
    <div className="flex h-full min-h-0 gap-2 overflow-hidden">
      ...
      {/* Aside Panel */}
      <aside className={`flex h-full min-h-0 flex-col overflow-hidden rounded-xl bg-white transition-all duration-200 ease-in-out ${isPreviewExpanded && (filteredLeads.length > 0 || panelMode === "create") ? "w-[50%]" : "w-0"}`}>
        {isPreviewExpanded && (filteredLeads.length > 0 || panelMode === "create") && (
