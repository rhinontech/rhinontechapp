    ...
    <div className="flex flex-col bg-white rounded-xl w-full h-full flex-1 min-h-0">
      ...
      <div className="sticky top-0 w-full flex flex-col justify-between bg-white z-10 rounded-t-xl">
        <div className="px-6 py-4 flex items-center gap-4">
          ...
          <h1 className="text-xl font-bold tracking-tight">Billings</h1>
        </div>
        ...
        <div className="flex items-center gap-6 px-6 border-b">
          <p
            ...
            onClick={() =>
              router.push("/admin/settings/subscription/billings/overview")
            }
          >
            Overview
          </p>
          <p
            ...
            onClick={() =>
              router.push("/admin/settings/subscription/billings/invoices")
            }
          >
            Invoices
          </p>
          <p
            ...
            onClick={() =>
              router.push("/admin/settings/subscription/billings/settings")
            }
          >
            Payment details
          </p>
